...
async function main() {
  ...
  await prisma.$transaction(
    async (tx) => {
      await tx.payLinkClick.deleteMany();
      await tx.emailOpen.deleteMany();
      ...
      const clientOnTime = await tx.client.create({
        data: {
          userId: user.id,
          name: "Amaka Obi",
      ...
      const inv1a = await tx.invoice.create({
        data: {
      ...
      const inv1b = await tx.invoice.create({
        data: {
      ...
      const clientSometimesLate = await tx.client.create({
        data: {
          userId: user.id,
          name: "Emeka Nwosu",
      ...
      const inv2a = await tx.invoice.create({
        data: {
      ...
      const inv2b = await tx.invoice.create({
        data: {
      ...
      const inv2c = await tx.invoice.create({
        data: {
      ...
      const clientLate = await tx.client.create({
        data: {
          userId: user.id,
          name: "Biodun Fasanya",
      ...
      const inv3a = await tx.invoice.create({
        data: {
      ...
      const inv3b = await tx.invoice.create({
        data: {
      ...
      const inv3c = await tx.invoice.create({
        data: {
      ...
      const clientGhost = await tx.client.create({
        data: {
          userId: user.id,
      ...
      const inv4a = await tx.invoice.create({
        data: {
      ...
      const inv4b = await tx.invoice.create({
        data: {
      ...
      const clientNew = await tx.client.create({
        data: {
          userId: user.id,
          name: "Ngozi Adaora",
      ...
      const clientMixed = await tx.client.create({
        data: {
          userId: user.id,
          name: "Segun Bello",
      ...
      const inv6a = await tx.invoice.create({
        data: {
